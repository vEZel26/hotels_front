        ...
        <Header />
          <div className='numbersFond'>
            <div>
              ...
              <div>
                <p>Завтра входит в стоимость оплаты всех номеров</p>
                <div>
            ...
            <div>
              ...
              <div>
                <p>Завтраки, включенные в стоимость оплаты каждого номера проходят в открытом кафе или в ресторане. Уличное кафе предлагает своим гостям прохладительные напитки и легкие закуски.</p>
                <div>
            ...
            <div>
              ...
              <div>
                <p>Утренние завтраки включенные в стоимость каждого номера, проходят в помещении ресторана или на открытой веранде-кафе. Посетители нашего Загородного Клуба всегда могут заказать блюда по меню. Есть детское меню.</p>
                <div>
